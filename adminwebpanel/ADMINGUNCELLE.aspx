<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADMINGUNCELLE.aspx.cs" Inherits="adminwebpanel.ADMINGUNCELLE" %>
...
<head>
    ...
    <!-- css files -->
    <link href="webguncelleme/css/style.css" rel="stylesheet" type="text/css" media="all" />
    <!-- css files -->
...
<body>
    ...
    <div class="main">
        <div class="main-w3l">
            <h1 class="logo-w3">Edit admin info's</h1>
